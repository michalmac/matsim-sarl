...
public class CreateHasseltNetwork
{
    public static void main(String[] args)
    {
        ...
        String osmFile = "d:/eclipse/smartpt/SmartPtFramework/input/osm/tripSequenceComposer.osm";
        String networkFile = "d:/eclipse/smartpt/SmartPtFramework/input/osm/tripSequenceComposer.xml";
